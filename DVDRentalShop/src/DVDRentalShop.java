...
public class DVDRentalShop extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DVDRentalShop frame = new DVDRentalShop();
